...
![Average wait time by department](visuals/avg_wait_by_department.png)
Wait time by time of day
![Wait time by time of day](visuals/wait_time_by_time_block.png)
Cancellation rate: long wait vs not long wait
![Cancellation rate](visuals/cancellation_long_wait.png)
